...
import iconY from 'client/src/components/Application/About/images/marker-iconY.png';
import icon2Y from 'client/src/components/Application/About/images/marker-icon-2xY.png';
